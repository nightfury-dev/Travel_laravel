...
class EnquiryController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $enquiries = Enquiry::where('staff_id', $user_id)
            ...
            return view('pages.admin.enquiry.search', $data)->render();
        }
        ...
        return view('pages.admin.enquiry.index', [
    ...
    public function create()
    {
        ...
        $customer = User::where('account_type', 1)
            ->orWhere('account_type', 2)
            ->orderBy('account_type')->get();

        return view('pages.admin.enquiry.create', compact('customer'));
    }
    ...
    public function add(Request $request)
    {
        ...
        $new_enquiry->customer_id = $request->customer_id;
        $new_enquiry->staff_id = Auth::user()->id;
        ...
        return redirect()->route('admin.enquiry')->with('msg', 'enquiry created');
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('pages.admin.enquiry.edit', compact('custom_enquiry', 'customer'));
    }
    ...
    public function update(Request $request)
    {
        ...
        $update_enquiry->customer_id = $request->customer_id;
        $new_enquiry->staff_id = Auth::user()->id;
        ...
        return redirect()->route('admin.enquiry')->with('msg', 'enquiry updated');
    }
    ...
    public function get_messages(Request $request)
    {
        ...
        return view('pages.admin.enquiry.message', $data)->render();
    }
