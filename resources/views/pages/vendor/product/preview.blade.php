<div class="card shadow-none mb-0 p-0 pb-1">
    <div class="card-header d-flex justify-content-between align-items-center border-bottom">
        ...
        <div class="app-file-action-icons d-flex align-items-center">
            <a href="{{ route('vendor.product.edit', ['product_id' => $product->id]) }}" style="color: #475F7B;">
                <i class="bx bx-edit cursor-pointer mr-50"></i>
            </a>
            <a href="javascript:void(0)" onclick="product_delete(this);" data-index="{{ $product->id }}" data-href="{{ route('vendor.product.delete', ['product_id' => $product->id]) }}" style="color: #475F7B;">
