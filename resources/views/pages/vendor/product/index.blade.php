  ...
  <div class="app-file-area">
    ...
    <div class="app-file-content p-2">
      <div class="d-flex align-items-center justify-content-between">
        ...
        <a href="{{ route('vendor.product.add') }}" class="btn btn-primary glow">
          <i class="bx bx-plus"></i>Add Product
        </a>
      </div>
      <label class="app-file-label"></label>
      <div id="product_list">
        @include('pages.vendor.product.search')
      </div>
    </div>
  </div>
@endsection
...
<script src="{{asset('js/scripts/pages/vendor/product.js')}}"></script>
@endsection
