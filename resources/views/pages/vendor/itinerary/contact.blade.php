...
<div class="modal fade text-left" id="send_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="send_form" name="send_form" action="{{ route('vendor.itinerary.contact.send') }}" method="POST">
                @csrf
...
?>
                            ...
                            <form>
                                <fieldset class="faq-search-width position-relative">
                                    <input type="text" class="form-control round form-control-lg shadow pl-2"
                                        id="searchbar" placeholder="Search message...">
                                </fieldset>
                            </form>
                        </div>
                    </div>
            ...
            <div class="col-md-3">
                <ul class="nav nav-tabs float-right" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn-primary glow white" href="{{ route('vendor.itinerary') }}">
...
<section class="wrapper-content">
    @include('pages.vendor.itinerary.contact_search')
</section>
...
<script src="{{asset('js/scripts/pages/vendor/contact.js')}}"></script>
<script>
