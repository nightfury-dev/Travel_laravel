                ...
                <ul class="nav nav-tabs float-right" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link btn-primary glow white" id="account-tab"
                            href="{{route('admin.task', ['itinerary_id' => $itinerary_id, 'type' => $type]) }}">
                                ...
                                <table id="task_detail_table" class="table invoice-data-table dt-responsive nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>
                                                <img src="{{ asset('storage/'.$detail->get_product_main_gallery()) }}"
                                                    alt="product gallery" class="img-thumbnail"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item" href="javascript:void(0)"
                                                            onClick="task_detail_del({{$detail->id}})">
                                                            <i class="bx bx-trash mr-1"></i> Remove from Task
                                                        </a>
                                                    </div>
                                                </div>
                                            </td>
