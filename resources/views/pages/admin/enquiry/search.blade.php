    ...
    <div class="action-left d-flex align-items-center">
        ...
        <ul class="list-inline m-0 d-flex">
            <li class="list-inline-item">
                <a href="{{ route('admin.enquiry.create') }}" class="btn btn-icon action-icon">
        ...
        <li class="media">
            ...
            <div class="dropdown enquiry-tool" style="margin-left: 30px;">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="{{ route('admin.enquiry.edit', ['enquiry_id' => $enquiry->id]) }}" class="dropdown-item">
                        <i class='bx bx-edit mr-1'></i>
                        Edit
                    </a>
                    <a href="{{ route('admin.itinerary.build', ['id' => $enquiry->id, 'type' => 0]) }}"
                        class="dropdown-item">
