            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="user_info" aria-labelledby="customer-tab" role="tabpanel">
                        <form class="form-horizontal" method="post" action="{{ route('admin.profile.update') }}" novalidate>
                        @csrf
                    ...
                    <div class="tab-pane" id="pwd_setting" aria-labelledby="account-tab" role="tabpanel">
                        <form class="form-horizontal" method="post" action="{{ route('admin.profile.password') }}" novalidate>
                        @csrf
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    <h6>New Password</h6>
...
<script>
    ...
    var base_url_home = "{{ url('/admin') }}";
    function back(){
        document.location.href=base_url_home + '/';
    }
</script>
<script src="{{asset('js/scripts/pages/admin/profile.js')}}"></script>
@endsection
