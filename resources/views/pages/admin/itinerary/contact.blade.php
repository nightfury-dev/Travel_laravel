...
<div class="modal fade text-left" id="send_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="send_form" name="send_form" action="{{ route('admin.itinerary.send_message') }}" method="POST">
              @csrf
              ...
              <div class="modal-body">
                  <div class="row mb-2">
                    <div class="col-md-12">
                      <textarea class="form-control" rows="6" placeholder="Please Enter New Message." id="message" name="message" required></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
        ...
        <div class="row breadcrumbs-top">
                ...
                <div class="card-content">
                  <div class="card-body p-0">
                    <fieldset class="faq-search-width position-relative">
                      <input type="text" class="form-control round form-control-lg shadow pl-2" id="searchbar" placeholder="Search message...">
                    </fieldset>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-3">
                <ul class="nav nav-tabs float-right" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn-primary glow white" href="{{ route('admin.itinerary') }}">
...
<section class="wrapper-content" id="message_list">
  @include('pages.admin.itinerary.contact_search')
</section>
...
<script src="{{asset('js/scripts/pages/admin/itinerary_contact.js')}}"></script>
<script>
