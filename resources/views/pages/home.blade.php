...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/pages/home-plugin.css')}}">
  ...
  <body>
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg fixed-top py-3 backdrop" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container">
          <a class="navbar-brand d-flex align-items-center fw-bold fs-2" href="{{ route('home') }}"> 
            <img class="d-inline-block align-top img-fluid" src="{{ asset('images/landing/logo-icon.png') }}" alt="" width="50" />
            <span class="text-primary fs-4 ps-2">Travel Quoting</span>
          </a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <form class="ps-lg-5" id="logout-form" action="{{ route('logout') }}" method="POST">
                @csrf
                @guest
                  <a href="{{ route('login') }}" class="btn btn-lg btn-outline-primary order-0">Sign In</a>
                @endguest
                @auth
                  <button class="btn btn-lg btn-outline-primary order-0" type="button" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Sign Out</button>
                @endauth
            </form>
          </div>
        </div>
      ...
      <section class="py-0">
        <div class="bg-holder d-none d-md-block" style="background-image:url({{ asset('images/illustrations/hero.png') }});background-position:right bottom;background-size:contain;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container position-relative">
          <div class="row align-items-center min-vh-75 my-lg-8">
            <div class="col-md-7 col-lg-6 text-center text-md-start py-8">
              ...
              <p class="mt-4 mb-5 fs-1 lh-base">Plan and book your perfect trip with expert advice, <br class="d-none d-lg-block" />travel tips, destination information and <br class="d-none d-lg-block" />inspiration from us.</p>
              @guest
                <a class="btn btn-lg btn-primary hover-top" href="{{ route('register') }}" role="button">Sign Up Now</a>
              @endguest
            </div>
          </div>
        </div>
                    ...
                    <div class="row h-100">
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top">
                          <img class="img-fluid h-100" src="{{ asset('images/landing/maldives.png') }}" alt="" />
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top">
                          <img class="img-fluid h-100" src="{{ asset('images/landing/indonesia.png') }}" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                            <div class="pt-3"><span class="badge bg-primary">$860</span></div>
                            <div class="ps-3 d-flex justify-content-between align-items-center">
                      ...
                      <div class="col-md-4 mb-3 mb-md-0">
                        <div class="card h-100 text-white hover-top">
                          <img class="img-fluid h-100" src="{{ asset('images/landing/kathmandu.png') }}" alt="" />
                          <div class="card-img-overlay ps-0 d-flex flex-column justify-content-between bg-dark-gradient">
                    ...
                    <div class="carousel-indicators">
                      <div class="row h-100 w-100">
                        <div class="col-12 px-1">
                          <button class="active" type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="0" aria-current="true" aria-label="Slide 1">
                            <img class="d-block" src="{{ asset('images/landing/maldives-v.png') }}" alt="..." />
                          </button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="1" aria-label="Slide 2">
                            <img class="d-block" src="{{ asset('images/landing/tanzania.png') }}" alt="..." />
                          </button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="2" aria-label="Slide 3">
                            <img class="d-block" src="{{ asset('images/landing/kathmandu-v.png') }}" alt="..." />
                          </button>
                        </div>
                        <div class="col-12 px-1">
                          <button type="button" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="3" aria-label="Slide 4">
                            <img class="d-block" src="{{ asset('images/landing/chaina.png') }}" alt="..." />
                          </button>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="carousel-item active" data-bs-interval="10000">
                      <div class="row h-100">
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white">
                            <a class="stretched-link" href="!#">
                              <img class="img-fluid" src="{{ asset('images/landing/food.png') }}" alt="" />
                            </a>
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white">
                            <a class="stretched-link" href="!#">
                              <img class="img-fluid" src="{{ asset('images/landing/backpacking.png') }}" alt="" />
                            </a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white">
                            <a class="stretched-link" href="!#">
                              <img class="img-fluid" src="{{ asset('images/landing/beaches.png') }}" alt="" />
                            </a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white">
                            <a class="stretched-link" href="!#">
                              <img class="img-fluid" src="{{ asset('images/landing/art-culture.png') }}" alt="" />
                            </a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white">
                            <a class="stretched-link" href="!#">
                              <img class="img-fluid" src="{{ asset('images/landing/wild.png') }}" alt="" />
                            </a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="col-6 col-sm-4 col-xl-2 mb-3 hover-top px-2">
                          <div class="card h-100 w-100 text-white">
                            <a class="stretched-link" href="!#">
                              <img class="img-fluid" src="{{ asset('images/landing/hill.jpg') }}" alt="" />
                            </a>
                            <div class="card-img-overlay d-flex align-items-end bg-dark-gradient">
                        ...
                        <div class="card-body d-flex flex-center flex-column">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                              <img class="img-fluid" src="{{ asset('images/landing/user-2.png') }}" alt="" />
                            </div>
                          </div>
                    ...
                    <div class="col-12 col-lg-7 mb-3 mb-md-0">
                      <div class="card h-100">
                        <div class="card-body d-flex flex-center flex-column">
                          ...
                          <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                              <img class="img-fluid" src="{{ asset('images/landing/user-1.png') }}" alt="" />
                            </div>
                          </div>
                          <div class="mt-3 text-center">
      ...
      <section id="booking">
        <div class="bg-holder" style="background-image:url({{ asset('images/landing/booking.png') }});background-position:center;background-size:cover;">
        </div>
        <!--/.bg-holder-->
    ...
    <script src="{{asset('js/scripts/popper.min.js')}}"></script>
    <script src="{{asset('js/scripts/is.min.js')}}"></script>
    <script src="{{asset('js/scripts/plyr.polyfilled.min.js')}}"></script>
